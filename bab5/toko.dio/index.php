...
<html lang="en">
  ...
  <body>
    ...
    <div class="navbar">
      <img
        src="img/TOKO.DIO-removebg-preview.png"
        alt="logo"
        width="10%"
        height="10%"
      />
    ...
    <section id="categories" class="categories">
      ...
      <div class="row" id="categories-list">
        <div class="card">
          <div class="card-img">
            <img src="img/specs.jpg" alt="keeper" />
          </div>
        ...
        <div class="card">
          <div class="card-img">
            <img src="img/jersey.jpg" alt="skill" />
          </div>
          <div class="card-content">
            <h2>Jersey Futsal</h2>
            <h3>Rp 50.000</h3>
        ...
        <div class="card">
          <div class="card-img">
            <img src="img/sepatu.jpg" alt="kick" />
          </div>
          <div class="card-content">
            <h2>Microphone</h2>
            <h3>Rp 50.000</h3>
